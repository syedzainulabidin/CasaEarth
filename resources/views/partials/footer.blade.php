    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                <span>&copy; 2025 YourCompany. All rights reserved.</span>
            </div>
            <div class="col-md-6">
                <ul class="nav justify-content-center justify-content-md-end">
                    <li class="nav-item">
                        <a class="nav-link text-white px-2" href="#">Privacy</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-white px-2" href="#">Terms</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-white px-2" href="#">Support</a>
                    </li>
                </ul>
            </div>
        </div>
...
<div class="footer">
    <div class="sub-footer">
        <a class="navbar-brand" href="{{ route('home') }}"><img src="{{ asset('assets/images/logo.png') }}"
                alt=""></a>
        <p>Every transformation begins within — in the stillness between who we are and who we’re becoming.</p>
        <div class="icons">
            <svg xmlns="http://www.w3.org/2000/svg" width="40" viewBox="0 0 640 640">
                <path
...
<div class="end-footer">
    <p>CURA © 2025 All Rights Reserved</p>
</div>
